...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Test that retrieve objects from database storage"""
    ...
    @unittest.skipIf(models.storage_t == 'db', "not testing file storage")
    def test_count(self):
        """Test that counts objects from the DBStorage"""
        storage = models.storage
        storage.reload()
        ...
        city_data = {"name": "kwahu", "state_id": state_instance.id}
        ...
        all.occurance = storage.count()
        self.assertEqual(state_occurance, len(storage.all()))
